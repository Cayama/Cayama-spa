...
import fakeBbProducts from '../../../fakeBbProducts';
import './styles.css';
      ...
      <div className="general-container all">
        ...
        <div className="cards-button">
          <div className="cards-container">
            {fakeBbProducts.map(({ id, name, price, images }, index) => (
              <ProductCard key={id} id={id} photo={images} name={name} price={price} index={index} />
            ))}
          </div>
          <Link to="/checkout">
            <button
